...
DELETE FROM MEMBRE; 
DELETE FROM VOITURE;
DELETE FROM VOITURE_MEMBRE; 
DELETE FROM TRAJET; 
DELETE FROM DEMANDE_TRAJET; 
...
SELECT M.NOM, M.PRENOM, V.MARQUE, V.NOM
FROM MEMBRE AS M, VOITURE AS V, VOITURE_MEMBRE AS MV
WHERE MAIL_MEM = M.MAIL AND MV.VOIT_ID = V.ID;